...
namespace WorldWideAstronomy
{
    public static partial class WWA
    {
        ...
        /// -6 = bad second (<0)
        /// </returns>
        public static int wwaDtf2d(string scale, int tz, int iy, int im, int id, int ihr, int imn, double sec, ref double d1, ref double d2)
        {
            int js, iy2 = 0, im2 = 0, id2 = 0;
            double dj = 0, w = 0, day, seclim, dat0 = 0, dat12 = 0, dat24 = 0, dleap, time;
              //tz is Time Zone, added manually for now
            
            //fix hour day month year, if -tz goes below 0
            if (ihr < tz)
            {
                ihr = 24 + ihr - tz;
            ...
            //all above ifs were added and are not part of SOFA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
